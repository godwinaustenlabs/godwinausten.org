!(function () {
  'use strict';
  const t = '/_hcms/perf/v2', e = window, n = Math.pow (2, 31);
  var i = {
    mode: 'compressed',
    staticDomainPrefix: '//static.hsappstatic.net',
    bender: {
      depVersions: {
        'content-cwv-embed': 'static-1.840',
        'browserslist-config-hubspot': 'static-1.95',
        csstype: 'static-1.8',
        'head-dlb': 'static-1.567',
        HeadJS: 'static-2.405',
        'hoist-non-react-statics': 'static-3.9',
        'hs-test-utils': 'static-1.2401',
        'hub-http': 'static-1.1404',
        'hub-http-janus': 'static-1.449',
        'hub-http-rxjs': 'static-1.421',
        HubStyleTokens: 'static-2.5995',
        jasmine: 'static-4.106',
        'jasmine-runner': 'static-1.945',
        'metrics-js': 'static-1.3895',
        msw: 'static-1.39',
        quartz: 'static-1.1314',
        react: 'static-7.96',
        ...
        rxjs: 'static-5.10',
        StyleGuideUI: 'static-3.380',
        'testing-library': 'static-1.82',
        'webpack-env': 'static-1.4',
        enviro: 'static-4.204',
        'hs-promise-rejection-tracking': 'static-1.235',
        PortalIdParser: 'static-2.196',
        raven: 'static-3.26',
        'raven-hubspot': 'static-1.349',
      },
      depPathPrefixes: {
        'content-cwv-embed': '/content-cwv-embed/static-1.840',
        'browserslist-config-hubspot': '/browserslist-config-hubspot/static-1.95',
        csstype: '/csstype/static-1.8',
        'head-dlb': '/head-dlb/static-1.567',
        HeadJS: '/HeadJS/static-2.405',
        'hoist-non-react-statics': '/hoist-non-react-statics/static-3.9',
        'hs-test-utils': '/hs-test-utils/static-1.2401',
        'hub-http': '/hub-http/static-1.1404',
        'hub-http-janus': '/hub-http-janus/static-1.449',
        'hub-http-rxjs': '/hub-http-rxjs/static-1.421',
        HubStyleTokens: '/HubStyleTokens/static-2.5995',
        jasmine: '/jasmine/static-4.106',
        'jasmine-runner': '/jasmine-runner/static-1.945',
        'metrics-js': '/metrics-js/static-1.3895',
        msw: '/msw/static-1.39',
        quartz: '/quartz/static-1.1314',
        ...
        StyleGuideUI: '/StyleGuideUI/static-3.380',
        'testing-library': '/testing-library/static-1.82',
        'webpack-env': '/webpack-env/static-1.4',
        enviro: '/enviro/static-4.204',
        'hs-promise-rejection-tracking': '/hs-promise-rejection-tracking/static-1.235',
        PortalIdParser: '/PortalIdParser/static-2.196',
        raven: '/raven/static-3.26',
        'raven-hubspot': '/raven-hubspot/static-1.349',
      },
  ...
  var j,
    ...
    F = function (t, e, n, i) {
      ...
      return function (o) {
        e.value >= 0 &&
          ...
          ((r = e.value), (e.delta = a), (e.rating = (function (t, e) {
    ...
    J = function (t) {
      ...
      addEventListener ('visibilitychange', e, !0), addEventListener (
        'pagehide',
        e,
        !0
      );
    ...
    X = function () {
      addEventListener ('visibilitychange', W, !0), addEventListener (
        'prerenderingchange',
        W,
        !0
      );
    ...
    $ = function () {
      removeEventListener ('visibilitychange', W, !0), removeEventListener (
        'prerenderingchange',
        W,
        !0
      );
          ...
          a = z ('paint', function (t) {
            t.forEach (function (t) {
              'first-contentful-paint' === t.name &&
                (a.disconnect (), t.startTime < i.firstHiddenTime &&
                  ((r.value = Math.max (
                    t.startTime - O (),
                    0
                  )), r.entries.push (t), n (!0)));
            });
          });
        a &&
          ((n = F (t, r, Y, e.reportAllChanges)), H (function (i) {
            (r = D (
              'FCP'
            )), (n = F (t, r, Y, e.reportAllChanges)), _ (function () {
      ...
      (e = e || {}), Z (
        N (function () {
          var n,
            ...
            c = z ('layout-shift', o);
          c &&
            ((n = F (t, i, tt, e.reportAllChanges)), J (function () {
              o (c.takeRecords ()), n (!0);
            }), H (function () {
    ...
    rt = function (t, e) {
      j ||
        ((j = e), (k = t), (V = new Date ()), ct (removeEventListener), at ());
    },
    at = function () {
      if (k >= 0 && k < V - it) {
        var t = {
      ...
      if (t.cancelable) {
        ...
        'pointerdown' == t.type
          ? (function (t, e) {
              ...
              addEventListener ('pointerup', n, nt), addEventListener (
                'pointercancel',
                i,
                nt
              );
        ...
        var n,
          ...
          a = function (t) {
            t.startTime < i.firstHiddenTime &&
              ((r.value = t.processingStart - t.startTime), r.entries.push (
                t
              ), n (!0));
          },
          o = function (t) {
          ...
          c = z ('first-input', o);
        (n = F (t, r, st, e.reportAllChanges)), c &&
          J (
            N (function () {
          ...
          H (function () {
            ...
            (r = D (
              'FID'
            )), (n = F (t, r, st, e.reportAllChanges)), (x = []), (k = -1), (j = null), ct (addEventListener), (i = a), x.push (i), at ();
          });
      });
    },
    dt = 0,
    ...
    lt = function (t) {
      t.forEach (function (t) {
        t.interactionId &&
          ((ft = Math.min (ft, t.interactionId)), (pt = Math.max (
            pt,
            t.interactionId
          )), (dt = pt ? (pt - ft) / 7 + 1 : 0));
      });
    ...
    wt = {},
    St = function (t) {
      var e = bt[bt.length - 1], n = wt[t.interactionId];
      ...
      (e = e || {}), Q (function () {
        ...
        var i,
          ...
          a = function (t) {
            ...
            var e,
              n = ((e = Math.min (bt.length - 1, Math.floor (yt () / 50))), bt[
                e
              ]);
            n &&
              n.latency !== r.value &&
          ...
          o = z ('event', a, {
            durationThreshold: null !== (n = e.durationThreshold) &&
              void 0 !== n
              ? n
              : 40,
          });
        (i = F (t, r, vt, e.reportAllChanges)), o &&
          ('PerformanceEventTiming' in window &&
            'interactionId' in PerformanceEventTiming.prototype &&
            o.observe ({type: 'first-input', buffered: !0}), J (function () {
            a (
              o.takeRecords ()
            ), r.value < 0 && yt () > 0 && ((r.value = 0), (r.entries = [])), i (!0);
          }), H (function () {
      ...
      (e = e || {}), Q (function () {
        var n,
          ...
          a = function (t) {
            ...
            e &&
              ...
              ((r.value = Math.max (e.startTime - O (), 0)), (r.entries = [
                e,
              ]), n ());
          },
        ...
        if (o) {
          ...
          ['keydown', 'click'].forEach (function (t) {
            ...
            (r = D (
              'LCP'
            )), (n = F (t, r, Et, e.reportAllChanges)), _ (function () {
              (r.value =
                performance.now () - i.timeStamp), (Ct[r.id] = !0), n (!0);
            });
          });
        }
      });
    ...
    It = function (t, e) {
      e = e || {};
      var n = D ('TTFB'), i = F (t, n, At, e.reportAllChanges);
      Lt (function () {
        var r = q ();
        if (r) {
          var a = r.responseStart;
          if (a <= 0 || a > performance.now ()) return;
          (n.value = Math.max (a - O (), 0)), (n.entries = [r]), i (
            !0
          ), H (function () {
